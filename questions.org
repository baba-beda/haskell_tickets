...
~C :: (* -> *) -> *~
** [6/14]Question 4: Type hierarchy
...
#+END_SRC
*** TODO Напишите реализацию ~Foldable~ для ~Maybe~
*** TODO Напишите реализацию ~Foldable~ для ~Either~
*** TODO Напишите, что делают эти расширения языка: ~TypeSynonyms, MultiParamTypeClasses, ViewPatterns, RecordsWildCards~
*** TODO Реализуйте ~traverse~ через ~sequence~.
