...
** [15/18]Question 4: Type hierarchy
*** TODO Чему равно значение ~length (Left "hello")~ и почему?
/Написать подробнее/
...
#+END_SRC 
*** TODO Чему равно значение ~length (Just [1..10])~ и почему?
/Написать подробнее/

1
*** DONE Напишите ~typeclass~ ~Traversable~
#+BEGIN_SRC haskell
...
#+END_SRC
*** TODO Напишите ~type class Functor~ и его реализацию для ~((->) r)~
*** TODO Напишите ~type class Functor~ и его реализацию для ~Maybe~
*** TODO Напишите ~type class Functor~ и его реализацию для ~Either~
*** TODO Напишитe ~type class Functor~ и его реализацию для ~[]~
